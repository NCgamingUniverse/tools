...
import 'package:tools/voiceSub.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Tools", style: TextStyle(color: Colors.black)),
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
              ...
              Center(
                child: Text(
                  "Every tool you need to work with Voices in one place",
              ...
              Row(
                ...
                children: [
                  ...
                  buildContainer(Hei, Wid, "Audio Extracter"),
                  buildContainer(Hei, Wid, "Text to voice "),
                  buildContainer(Hei, Wid, "Voice to text"),
                  buildContainer(Hei, Wid, "Audio cutter"),
                  SizedBox(
                    width: Width * 0.1,
                  ),
                ],
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => ExtractAudioScreen(),
          ),
        );
      },
      child: MouseRegion(
